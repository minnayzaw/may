                                  ...
                                  <ul class="check-ul">
                                      <li>
                                          <div class="check-pro-img">
                                              <a href="products.html"><img src="{{url('image/pro-page-image/check-image-1.jpg')}}" class="img-fluid" alt="image"></a>
                                          </div>
                                          <div class="check-content">
                                              <a href="products.html">Fresh healthy food</a>
                                              <span class="check-code-blod">Product code: <span>CA70051541B</span></span>
                                              <span class="check-price">$100</span>
                                          </div>
                                      </li>
                                      <li>
                                          <div class="check-pro-img">
                                              <a href="products.html"><img src="{{url('image/pro-page-image/check-image-2.jpg')}}" class="img-fluid" alt="image"></a>
                                          </div>
                                          <div class="check-content">
                                              <a href="products.html">Fresh healthy food</a>
                                              <span class="check-code-blod">Product code: <span>CA70051541B</span></span>
                                              <span class="check-price">$200</span>
                                          </div>
                                      </li>
                                  </ul>
                              </div>
