                 ...
                 <div class="col-xl-9 col-lg-12 col-md-12 col-xs-12 pro-image">
                     <div class="row">
                         ...
                         <div class="col-lg-6 col-xl-6 col-md-6 col-12 col-xs-12 pro-info">
                             ...
                             <div class="pro-price">
                                 <input type="hidden" id="product_price" value="{{$product->price}}" name="product_price" />
                             ...
                             <div class="pro-qty">
                                 ...
                                 <div class="plus-minus">
                                     <span>
                                         ...
                                         <input id="product_quantity" type="text" name="name" value="{{$quantity}}">
                             ...
                             <div class="pro-btn">
                                 ...
                                 <a href="#" class="btn btn-style1" id="checkout">Buy now</a>
                             </div>
                             <!-- <div class="share">
                         ...
                         <div class="items">
                             <div class="tred-pro">
                                 <div class="tr-pro-img">
                                     <a class="product-detail" id="img_{{$rp->id}}" href="#">
                             ...
                             <div class="caption">
                                 <h3><a class="product-detail" id="title_{{$rp->id}}" href="#">{{$rp->title}}</a></h3>
                                 <!-- <div class="rating">
